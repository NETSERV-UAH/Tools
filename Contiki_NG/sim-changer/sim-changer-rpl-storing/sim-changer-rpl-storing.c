...
int main(int argc, char *argv[])
{
    ...
    strcpy(new_line1, "     <source>[CONTIKI_DIR]/examples/rpl-storing/sky-testscript/code/sink.c</source>\n");
    ...
    strcpy(new_line4, "      <source>[CONTIKI_DIR]/examples/rpl-storing/sky-testscript/code/mote.c</source>\n");
